 ...
 */
public abstract class FirebaseRecyclerAdapterNovo<ViewHolder extends RecyclerView.ViewHolder, T>
     ...
     */
    public FirebaseRecyclerAdapterNovo(Query query, Class<T> itemClass) {
    ...
    private ChildEventListener mListener = new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            if (!mKeys.contains(key)) {
                T item = dataSnapshot.getValue(FirebaseRecyclerAdapterNovo.this.mItemClass);
        ...
        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
            ...
            if (mKeys.contains(key)) {
                ...
                T newItem = dataSnapshot.getValue(FirebaseRecyclerAdapterNovo.this.mItemClass);
